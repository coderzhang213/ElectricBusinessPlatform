...
+ (NSInteger) getSecondIntervalBetweenDateA:(NSDate*) dateA andDateB:(NSDate*)dateB{
...
+ (NSInteger) getHalfTimeIntervalBetweenDateA:(NSDate*) dateA andDateB:(NSDate*)dateB{
...
//+ (NSTimeInterval)dateWithTimeIntervalSince1940:(NSNumber *) endDate{
//    
//    
//
//    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
//    [formatter setDateFormat:@"yyyy:MM:dd"];
//    
//    NSDate *startdDate=[formatter dateFromString:@"1940-1-1"];
//    
////    NSTimeInterval *timeInterval= [NSDate dateWithTimeInterval:[endDate doubleValue] sinceDate:startdDate];
//    
////    return [endDate timeIntervalSinceDate:startdDate];
//
//}
...
+ (NSTimeInterval)timeIntervalWithString:(NSString *)dateString{
    ...
    NSDate *startDate = [formatter dateFromString:@"1970-01-01"];
...
+ (NSString *)stringWithTimeInterval:(NSTimeInterval)time {
    ...
    NSTimeZone *timeZone = [NSTimeZone timeZoneWithName:@"UTC"];
    [formatter setTimeZone:timeZone];
    NSDate *date1 = [formatter dateFromString:@"1970-01-01"];
    NSDate *date = [date1 dateByAddingTimeInterval:time];
...
+ (NSString*) getLiveStringDependOnFormatterAFromDate:(NSDate*) date{
...
+ (NSString*) getPayBackLiveStringDependOnFormatterAFromDate:(NSDate*) date{
