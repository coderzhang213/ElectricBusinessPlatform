...
#import "ASNodeController+SSExpand.h"
#import <objc/runtime.h>

static const void *ContentNode = &ContentNode;

@implementation ASNodeController (SSExpand)
//- (void)setContentNode:(ASDisplayNode *)contentNode{
//    /*
...
//     */
//    objc_setAssociatedObject(self, ContentNode, contentNode, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//}
...
//    //利用runtime实现动态添加属性
//    ASDisplayNode *view = objc_getAssociatedObject(self, ContentNode);
